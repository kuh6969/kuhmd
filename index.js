...
function title() {
	  ...
	  console.log(color(`[•]`, 'aqua'), color(`Owner       : Kuh`, 'red'))
	  console.log(color(`[•]`, 'aqua'), color(`Devoloper    : @ramadhankukuh`, 'magenta'))
}
//COLOR
colors.setTheme({
warn:'yellow',
...
// OTHER
    ...
    let pa7rick = await conn.sendTextWithMentions(dill.from, `*KuhXD-Bot* tidak bisa menerima panggilan ${dill.isVideo ? `video` : `suara`}. Maaf @${dill.from.split('@')[0]} kamu akan diblockir. Jika tidak sengaja silahkan hubungi Owner untuk dibuka !`)
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await conn.getName(i + '@s.whatsapp.net')}\nFN:${await conn.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET: kuhra@ramadhankukuh.my.id\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/ramadhankukuh\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Semarang, Jawa Tengah, Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
